...
INSERT INTO user_details (id, email, family_name, gender, given_name, locale, name, picture, authority) VALUES (nextval('user_seq'), 'petrenko@vfasad.com.ua', 'Петренко', 'male', 'Вася', 'en', 'Вася Петренко', 'https://cdn3.iconfinder.com/data/icons/rcons-user-action/32/boy-512.png', 'ROLE_SALES');
